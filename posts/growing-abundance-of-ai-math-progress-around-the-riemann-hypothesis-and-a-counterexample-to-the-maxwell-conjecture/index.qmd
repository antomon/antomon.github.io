...
![Sumner's follow-up showing the opening prompt for the second session, including the instruction to use adversarial review and to "take a big leap of faith" in the model's capabilities.](sumner-x-2.png){#fig-sumner-claude-prompt fig-align="center" width="75%"}
