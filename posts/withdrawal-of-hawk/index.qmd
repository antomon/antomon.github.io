...
## The actual lesson: the race is not only against Q-Day
...
### The post-quantum transition is now a race between several clocks
...
```{mermaid}
%%| label: fig-hawk-post-quantum-race
%%| fig-cap: "The post-quantum security race is governed by multiple clocks. Quantum engineering advances the offensive capability frontier; classical and AI-assisted cryptanalysis continuously tests the defensive algorithms; organizations must migrate long-lived systems and trust infrastructures before either frontier invalidates the assumptions on which those systems depend."
%%| fig-alt: "A diagram showing four concurrent processes in the post-quantum security race: advances in quantum capability, cryptanalysis of post-quantum algorithms, standards and migration, and the lifetime of deployed digital trust. Quantum and cryptanalytic progress increase pressure while standards, crypto-agility, and migration reduce exposure."
%%| fig-align: center
%%{init: {"theme": "neo", "look": "handDrawn", "layout": "elk"}}%%
flowchart TD
...
* how quickly cryptographically relevant quantum computing becomes feasible;
* how quickly classical and AI-assisted cryptanalysis improves against candidate and deployed post-quantum constructions;
* how quickly standards, products, protocols, and organizations can migrate;
* how long existing data, devices, identities, signatures, certificates, trust anchors, and operational systems must remain secure.
...
This is the common thread connecting HAWK with the broader quantum-security problem developed in my earlier analyses. [*When Digital Trust Expires*](https://4m4.it/longforms/when-digital-trust-expires-quantum-computing-and-the-collapse-of-signature-based-security/) examined what happens when the cryptographic basis of authenticity expires. [*Quantum Cryptography at the Edge of Feasibility*](https://4m4.it/posts/quantum-cryptography-edge-feasibility-resource-estimates-architectural-divergence-systemic-risk/) examined the changing engineering distance between Shor's algorithm and a realizable attack. [*When Digital Trust Gets a Deadline*](https://4m4.it/posts/when-digital-trust-gets-a-deadline/index.html) examined the transition from an uncertain threat horizon to explicit migration deadlines.
...
[^withdrawal-of-hawk-nist-pqc-migration]: National Institute of Standards and Technology. (2026). **Post-Quantum Cryptography**. *NIST Computer Security Resource Center*. NIST states that, following publication of the first three final PQC standards, organizations should begin migrating their systems to quantum-resistant cryptography. [Official project page](https://csrc.nist.gov/projects/post-quantum-cryptography)

[^withdrawal-of-hawk-eu-pqc-roadmap]: European Commission. (2025). **A Coordinated Implementation Roadmap for the Transition to Post-Quantum Cryptography**. *Shaping Europe's Digital Future*. The roadmap calls for Member States to begin transitioning by the end of 2026 and for critical infrastructures to transition as soon as possible and no later than the end of 2030. [Official roadmap](https://digital-strategy.ec.europa.eu/en/library/coordinated-implementation-roadmap-transition-post-quantum-cryptography)

[^withdrawal-of-hawk-ncsc-pqc-timeline]: UK National Cyber Security Centre. (2025). **Timelines for Migration to Post-Quantum Cryptography**. *NCSC*. The guidance sets milestones of 2028 for discovery and initial planning, 2031 for highest-priority migrations, and 2035 for completion. [Official guidance](https://www.ncsc.gov.uk/guidance/pqc-migration-timelines)

[^withdrawal-of-hawk-us-pqc-order]: The White House. (2026). **Executive Order 14412 — Securing the Nation Against Advanced Cryptographic Attacks**. *The White House*, 22 June 2026. The order requires high-value assets and high-impact federal systems to use PQC for key establishment by 31 December 2030 and for digital signatures by 31 December 2031, and establishes related requirements for inventories, migration planning, a Cryptographic Bill of Materials, validation, critical-infrastructure support, and federal procurement. [Official text](https://www.whitehouse.gov/presidential-actions/2026/06/securing-the-nation-against-advanced-cryptographic-attacks/)
