...
Questa guida ti mostra come utilizzare un file Excel per controllare la validità delle Partite IVA tramite il servizio **VIES** (VAT Information Exchange System). Il post è diviso in due parti: la prima è pensata per gli utenti che non hanno esperienza di programmazione e la seconda è per chi ha conoscenze di base in **VBA** e vuole modificare o personalizzare il file Excel o il codice.
