...
| **Fornitori** | Vendor aerogeneratori, plant controller, SCADA, BoP e O&M devono essere governati contrattualmente e tecnicamente. |

La conseguenza pratica è che un impianto eolico soggetto ad A.17 deve essere progettato come una catena OT completa: aerogeneratori, plant controller, protezioni, SCADA, RTU, UPDM, apparati di comunicazione e interfacce verso Terna devono essere coerenti, testabili e mantenuti nel tempo.
...
Anche in questo caso, l’oggetto non è solo la connessione elettrica dell’impianto fotovoltaico. L’allegato disciplina prestazioni, protezioni, regolazione, controllo, visibilità sul sistema di controllo del Gestore, monitoraggio della conformità e scambio dati. Il plant controller fotovoltaico, gli inverter, le protezioni, le misure e l’interfaccia con UPDM diventano quindi elementi della catena IT/OT rilevante per Terna.
...
Questo produce un impatto concreto sul plant controller e sugli inverter. La limitazione della produzione non è più solo una funzione locale, commerciale o di dispacciamento. Diventa una funzione integrata nella catena di controllo e difesa: il sistema deve poter ricevere segnali, tradurli in limiti di potenza, attuarli nei tempi richiesti, monitorarne l’effetto e fornire evidenze coerenti verso Terna.
...
|---|---|
| **Plant controller / PPC** | Supporto a regolazione, limitazione, setpoint, stati, misure e interazione con UPDM. |
...
Questo implica una governance strutturata delle evidenze. Il Titolare deve sapere quali prove sono state effettuate, con quale configurazione, con quali firmware, con quali setting, con quale strumentazione, con quali risultati e con quali eventuali eccezioni. Se nel frattempo cambiano plant controller, inverter, aerogeneratori, firmware, protezioni, UPDM, RTU, router, SCADA o logiche di controllo, deve essere chiaro se la precedente evidenza è ancora valida o se serve una nuova verifica.
...
| **Sistemi di controllo** | Plant controller, SCADA, parallelo, regolatori, protezioni e UPDM devono supportare prove e raccolta dati. |
...
| **Fornitori** | Obblighi contrattuali verso BoP, O&M, vendor inverter/aerogeneratori, plant controller, EMS/BMS, telco e manutentori. |
