...
difficulty: advanced
audiences: practitioner, technical specialist, subject-matter-expert, researcher, analyst
...
The system had four explicit components. First, a reasoning model performed the natural-language mathematical work: choosing directions, forming arguments, planning experiments, and evaluating claims. Second, a coding agent implemented computations requested by the reasoning model, including numerical experiments and interval-arithmetic certification. Third, a bulletin file carried human instructions into the running system. Fourth, session reports served as long-term memory, preserving proofs, code, failures, caveats, and prose summaries for later sessions.[^when-ai-failure-became-a-theorem-what-the-grothendieck-constant-breakthrough-reveals-about-human-ai-mathematical-collaboration-li-saha-xue-collaboration] This design matters because the Grothendieck constant problem required neither pure symbolic manipulation nor pure numerical search. It required a dialogue between analytic structure and certified computation.
...
The collaboration paper’s most useful analytical contribution is its separation of mathematical research into three functions: technical execution, research judgement, and research-state representation. Technical execution is the ability to carry out a chosen task: prove a lemma, test a construction, write code, interpret a computation, or repair a local argument. Research judgement is the ability to choose what should be attempted next. Research-state representation is the ability to preserve the evolving structure of the programme: what is known, what is conjectural, what failed, which caveats matter, and which unresolved obligations govern future work.[^when-ai-failure-became-a-theorem-what-the-grothendieck-constant-breakthrough-reveals-about-human-ai-mathematical-collaboration-li-saha-xue-collaboration]
