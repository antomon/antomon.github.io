...
flowchart TD
    classDef blue fill:#e6f0fa,stroke:#1e73be,stroke-width:2px,color:#1e73be;
    classDef red fill:#fdeaea,stroke:#c0392b,stroke-width:2px,color:#c0392b;
    classDef green fill:#e9f7ef,stroke:#27ae60,stroke-width:2px,color:#27ae60;

    S([Start: Define process envelope]):::blue --> A{Complexity/Variability\nHigh?}:::red
    A -- Yes --> H1[Human-led\n(judgment, relationships)]:::red
    A -- No --> B{Volume/Repeatability\nHigh?}:::green
    B -- Yes --> AG1[Agent-led\n(rules, telemetry, rollback)]:::green
    B -- No --> C{Compliance/Sensitivity\nMixed?}:::blue
    C -- Yes --> HY1[Hybrid\n(agent pre-checks + human sign-off)]:::blue
    C -- No --> H2[Human-led]:::red
    H1 --> E([Pilot & KPI gate]):::blue
    AG1 --> E
    HY1 --> E
    H2 --> E
```
