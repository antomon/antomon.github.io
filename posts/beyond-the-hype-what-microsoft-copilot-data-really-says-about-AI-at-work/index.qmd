...
This high agreement at broad group level (e.g., Sales, Office Support, Computer and Mathematical roles) suggests that **predicted exposure patterns are largely borne out in early real-world use**. However, at the detailed occupation level, discrepancies emerge:

* **Microsoft higher than Eloundou**: *Market Research Analysts*, *CNC Tool Programmers*, *Passenger Attendants* – likely because the predictive model underweighted the informational and communication components these jobs actually exhibit in practice.

* **Eloundou higher than Microsoft**: * *Physicists*, *Environmental Scientists*, *Survey Researchers* – these are specialized, lower-employment roles whose tasks may be well-suited to AI in theory but are infrequently represented in Copilot usage, thus falling below Microsoft’s coverage threshold.

**Interpretation:** Observed usage captures the *actual adoption curve*—what workers are doing with AI today—while predictive models capture *capability potential*. The divergence is a signal that adoption lags (or leads) capabilities depending on sectoral incentives, tool access, and organizational readiness.

#### EU Comparisons: OECD, IMF, and JRC Studies

##### OECD (2023) – Impact of AI on EU Labour Markets

EU survey data finds **broad professional services and public administration exposure**—a pattern mirrored in Microsoft’s U.S. results for education, legal, and office support, but with *wider sectoral spread* in the EU due to higher adoption in government workflows.

##### IMF / Brussevich et al. (2023)

* Predicts **more balanced AI exposure across wage tiers in Europe** compared to the U.S.

* Microsoft’s weak wage correlation (r ≈ 0.07) aligns with the “not wage-skewed” thesis, but U.S. adoption patterns currently favor high-communication, lower-wage large-employment groups like sales and customer service—less visible in IMF’s EU data.

##### European Commission JRC (2024) – Generative AI at Work

Using Eurostat microdata, finds stronger *predicted* exposure in technical/engineering roles than Microsoft observes for the U.S. Copilot dataset. This could be due to:

  1. Higher enterprise adoption of AI in engineering in the EU context.

  2. Microsoft Copilot’s U.S. user base being less concentrated in engineering-heavy firms.
...
* **Governance repositioning** – new oversight roles (e.g., *Chief AI Officer*) emerging to manage agent-driven processes across departments.
...
Taken together, the Microsoft study, the Fortune case evidence, and the CARO governance model describe a **continuous transformation arc**. At one end, we have **task-level applicability**—a granular, data-driven view of where AI already works alongside humans, mapping current opportunities and constraints with empirical precision. At the other end, we have **structural embedding**, where AI agents are no longer transient assistants but enduring operational actors, reorganizing the very topology of the enterprise. The bridge between these points is **governance**: without a unifying function like a Chief Agency Resources Officer, adoption risks fragmenting, efficiencies go unrealized, and accountability gaps widen. With integrated governance, applicability scores evolve from static measurements of potential into dynamic levers for strategic allocation—directing both human talent and AI capacity within a single, coherent resource strategy. This is not a handover from humans to machines, but a managed convergence of capabilities, where occupational change and organizational redesign advance in lockstep under deliberate oversight.
...
1. **Stage one – Augmented information systems:**
...
2. **Stage two – Agent-orchestrated process islands:**
...
3. **Stage three – Virtual agent operational platform (VAOP):**
...
4. **Implications across the enterprise stack:**
...
5. **Strategic choice becomes structural design:**
