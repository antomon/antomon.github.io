...
%%| fig-align: center
%%{init: {"theme": "neo", "look": "handDrawn", "themeVariables": { "fontSize": "16px", "lineWidth": 3 }}}%%
...
flowchart TD
  ...
  %% Node styles
  style S stroke:#1e73be,fill:#e6f0fa,color:#1e73be,stroke-width:3px
  style A stroke:#c0392b,fill:#fdeaea,color:#c0392b,stroke-width:3px
  style B stroke:#27ae60,fill:#e9f7ef,color:#27ae60,stroke-width:3px
  style C stroke:#1e73be,fill:#e6f0fa,color:#1e73be,stroke-width:3px

  style H1 stroke:#c0392b,fill:#fdeaea,color:#c0392b,stroke-width:3px
  style H2 stroke:#c0392b,fill:#fdeaea,color:#c0392b,stroke-width:3px
  style AG1 stroke:#27ae60,fill:#e9f7ef,color:#27ae60,stroke-width:3px
  style HY1 stroke:#1e73be,fill:#e6f0fa,color:#1e73be,stroke-width:3px
  style E stroke:#1e73be,fill:#e6f0fa,color:#1e73be,stroke-width:3px
...
Moreover, **AI applicability scoring** (as used in the Microsoft study) is based on occupational taxonomies like O\*NET, where task encoding for robotics-heavy roles often includes *intermediate work activities* that are inherently physical. Predictive models can, in principle, extend to these roles, but without adoption telemetry from robotic platforms, **capability potential cannot be validated against real-world use** in the same way as office-based agents.
