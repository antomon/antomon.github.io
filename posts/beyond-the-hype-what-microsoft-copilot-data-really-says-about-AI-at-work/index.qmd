...
subtitle: "From lofty predictions to real-world clicks—how observed generative AI use reshapes our view of job impact in the U.S. and Europe"
format:
  html:
    toc: true
    toc-expand: 3
...
## Micosoft study methodology: from conversation logs to cccupational impact
...
The end goal is a composite measure—the **AI Applicability Score**—quantifying the relative potential for AI to affect an occupation. It is defined per occupation *i* as:
...
##### **OECD (2023) – Impact of AI on EU labour markets**

OECD’s analysis of European survey data indicates **high exposure in professional services and public administration**, with legal, education, and office support roles showing particularly strong alignment to AI-suitable task profiles. This pattern broadly mirrors Microsoft’s U.S. results for education, legal, and administrative functions, but the **sectoral footprint is wider in the EU**. 

A key driver is the earlier and more coordinated integration of AI-enabled tools into **government and public service workflows**—especially in digital administration, tax services, and citizen-facing portals—an adoption path less pronounced in the U.S., where government uptake has been slower and more fragmented.

##### **IMF / Brussevich et al. (2023)**

The IMF projects a **more balanced distribution of AI exposure across wage tiers in Europe** than in the United States. While Microsoft’s U.S. telemetry shows only a weak correlation between wage level and observed AI applicability (r ≈ 0.07), the underlying occupational patterns differ. In the U.S., early adoption skews toward **large-employment, high-communication, lower-to-mid-wage roles** such as sales representatives and customer service agents. 

These roles are less prominent in the IMF’s European exposure maps, which suggest a **flatter wage-exposure profile** due to broader deployment across mid- and high-wage technical and professional occupations. This divergence may reflect differences in **collective bargaining structures, national upskilling programs, and sectoral AI integration strategies** between the two regions.

##### **European Commission JRC (2024) – Generative AI at work**

Drawing on Eurostat microdata, the JRC predicts **higher AI exposure in technical and engineering roles** than Microsoft’s U.S. Copilot dataset suggests. Two non-exclusive explanations stand out:

1. **Sectoral concentration:** European firms in manufacturing, engineering, and applied sciences appear to be adopting AI-enhanced CAD, simulation, and documentation tools more rapidly, increasing observed technical role exposure.

2. **Platform bias:** Microsoft’s Copilot telemetry is skewed toward its U.S. enterprise customer base, which may have a **lower representation of engineering-heavy industries** compared to the EU sample, especially in export-oriented manufacturing sectors.

The combined view of OECD, IMF, and JRC work suggests that **AI’s occupational footprint in Europe is both more evenly distributed across wage bands and more deeply embedded in technical professions** than current U.S. Copilot usage data would imply. This underscores the importance of **region-specific adoption drivers**—including public sector leadership, industrial policy, and the prevalence of engineering-intensive sectors—when interpreting global applicability patterns.
...
| ----------------------- | --------------------------------------------------- | -------------------------------------------------------- | ----------------------------------------------------------- |
| **High-exposure roles** | Knowledge, communication, sales, language-intensive | Similar; plus technical/scientific in predictions        | Adoption vs. capability gap                                 |
| **Low-exposure roles**  | Physical/manual jobs, on-site operational           | Similar, though robotics-focused AI could change picture | Modality limits (LLMs vs. physical AI)                      |
| **Wage correlation**    | Weak positive (r ≈ 0.07)                            | Often predicted higher in top wage tiers                 | Large low-wage, high-communication job groups in U.S. usage |
| **Sector breadth (EU)** | Narrower in U.S. data                               | Wider in EU surveys and models                           | Higher EU adoption in public/admin sectors                  |


Bottom line:

* Observed applicability aligns broadly with capability-based forecasts but reveals **a narrower occupational footprint in the early adoption phase**, heavily shaped by platform demographics and access. 

* This suggests that *measuring AI’s real labor market footprint requires triangulating multiple lenses*—usage logs for adoption reality, capability mapping for potential, and survey data for sectoral context.
...
The bridge between these points is **governance**: without a unifying function like a Chief Agency Resources Officer, adoption risks fragmenting, efficiencies go unrealized, and accountability gaps widen. With integrated governance, applicability scores evolve from static measurements of potential into dynamic levers for strategic allocation—directing both human talent and AI capacity within a single, coherent resource strategy. 
...
* **Stage one – Augmented information systems:**
...
* **Stage two – Agent-orchestrated process islands:**
...
* **Stage three – Virtual agent operational platform (VAOP):**
...
Nolan, B. (2025, August 7). *https://doi.org/10.48550/arXiv.2507.07935*. Fortune. [URL](https://fortune.com/2025/08/07/ai-corporate-org-chart-workplace-agents-flattening/)
