...
description: "The Dutch government’s Forgejo-based code platform treats source-code hosting as part of sovereign public infrastructure. This article explains why control over repositories, reviews, identities, releases, and software-supply-chain evidence is essential to public-sector autonomy, and how `code.overheid.nl` connects Dutch open-source policy with European interoperability, cyber resilience, and digital commons."
abstract: |
  This article examines `code.overheid.nl`, the Dutch government’s Forgejo-based platform for developing and publishing public-sector software. It argues that a Git forge is not merely a repository service, but a control point for identities, code review, release provenance, automation, security evidence, and the lifecycle of digital public services.

  The initiative translates Dutch _open, unless_ policy and European objectives for digital autonomy, interoperability, cyber resilience, and reusable digital commons into operational infrastructure. Its strategic value depends not on self-hosting alone, but on governed identity, secure development workflows, vulnerability management, auditability, sustained maintenance, and effective reuse across administrations.
date: "2026-04-30"
date-modified: "2026-04-30"
categories: [EU digital sovereignty, software engineering, 🇬🇧]
...
The first risk is _symbolic sovereignty_: creating a national forge but continuing to develop critical code elsewhere because developer experience, tooling, automation, or support are insufficient. That would create a public façade rather than a real operational shift.

The second risk is _fragmentation_. If every administration creates its own isolated forge without federation, shared metadata, shared licensing practices, and shared discovery mechanisms, the result may be many sovereign islands rather than a reusable public software ecosystem.

The third risk is _underfunded maintenance_. Open source does not remove the need for sustained engineering. It shifts the investment from licence rent to capability, maintenance, security, community governance, and long-term stewardship.

The fourth risk is _confusing self-hosting with security_. Self-hosting increases control, but it also increases responsibility. A poorly operated sovereign forge can be less secure than a mature external platform. The decisive variable is not ownership alone; it is governed operational capability.
