...
description: "Quantum Key Distribution and post-quantum cryptography are often presented as alternative responses to quantum computing, although they solve different problems. This article separates confidentiality, key establishment, authentication, digital signatures, and long-term verifiability to show why PQC is the structural basis of quantum-safe digital trust, while QKD remains an optional mechanism for distributing symmetric keys under restrictive physical and operational assumptions."
abstract: |
  Quantum computing does not invalidate cryptography as a whole. Its principal structural effect is to undermine the mathematical hardness assumptions supporting widely deployed public-key systems, including RSA and elliptic-curve cryptography. Symmetric cryptography remains viable with appropriately selected parameters, but key establishment, authentication, digital signatures, certificates, secure boot, software provenance, and other public-key trust functions require replacement mechanisms.

  Two technologies are commonly proposed in response: Quantum Key Distribution and post-quantum cryptography. Although they are frequently discussed as competing approaches, they operate at different layers and provide different security properties. QKD uses quantum states to establish shared symmetric keys and can make interception of the quantum channel detectable under its security assumptions. It does not, however, authenticate endpoints, sign software or documents, bind identities to keys, or preserve the verifiability of artifacts across time.

  PQC consists of classical cryptographic algorithms designed to resist known quantum attacks. It can replace vulnerable public-key primitives within existing communication, identity, certificate, and signature infrastructures. PQC therefore addresses the complete functional surface of public-key cryptography: key establishment, authentication, digital signatures, and long-term verification. Its security remains computational and assumption-dependent, but it can be deployed through software and protocol evolution without requiring dedicated quantum channels.

  The relationship between the two approaches is asymmetric. QKD requires an authenticated classical channel to prevent active impersonation and man-in-the-middle attacks. In a quantum-capable threat model, that authentication must itself remain secure against quantum attacks and may therefore be provided through post-quantum signatures or previously established symmetric authentication. PQC does not require QKD and can independently provide both authenticated key establishment and digital signatures. QKD can consequently augment a post-quantum architecture in selected environments, but it cannot replace its trust infrastructure.

  This distinction becomes clearer when quantum risk is examined temporally. Harvest-now-decrypt-later attacks threaten the future confidentiality of data captured today, while quantum forgery threatens the authenticity of certificates, firmware, software updates, contracts, audit records, and other long-lived signed artifacts. QKD protects neither previously captured information nor the future verifiability of historical signatures. Its effect is confined to the establishment of present-time symmetric keys over supported links.

  The article concludes that a coherent quantum-safe strategy must preserve three properties simultaneously: secure communication, authenticated identity, and durable verification of digital artifacts. PQC is structurally required across enterprise, cloud, industrial, embedded, and public infrastructures because it addresses all three. QKD remains a specialized and infrastructure-intensive option for narrowly bounded communication scenarios in which its physical assumptions, operational limitations, and cost are justified.
date: "2023-06-23"
