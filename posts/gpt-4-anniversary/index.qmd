...
description: "A retrospective on GPT-4’s first year, examining its rapid public adoption, multimodal evolution, performance on professional assessments, effects on knowledge work, and position within the increasingly competitive generative AI landscape of March 2024."
abstract: |
  One year after GPT-4’s release, this article reviews how the model accelerated the acceptance of generative AI and expanded expectations for machine reasoning, multimodal interaction, and professional knowledge work.

  It discusses research on human-like behavior and the uneven productivity effects of AI, then surveys the March 2024 market landscape, including OpenAI’s model offering and competition from Anthropic and Cohere. The article presents a historical snapshot of the moment when advanced language models became a mass technological phenomenon.
date: "2024-03-15"
...
![Mira Murati one-year anniversary celebration tweet](murati-1y.png){fig-alt="Mira Murati one-year anniversary celebration tweet" fig-align="center"}
