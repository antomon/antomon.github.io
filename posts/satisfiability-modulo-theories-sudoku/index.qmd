...
- **Mini Sudoku** ($4 \time 4$ grid): This is a smaller version, ideal for beginners. The subgrids are $2 \time 2$, and the puzzle uses digits 1 to 4.

- **Standard Sudoku** ($9 \time 9$ grid): This is the most common version, with $3 \time 3$ subgrids and digits 1 to 9.

- **Large Sudoku** ($16 \time 16$ grid): This uses larger grids, $4 \time 4$ subgrids, and digits 1 to 16.

- **Extreme Sudoku** ($25 \time 25$ grid): Rarely seen, this massive grid uses $5 \time 5$ subgrids and digits 1 to 25, and is extremely challenging.
