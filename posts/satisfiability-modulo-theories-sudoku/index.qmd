...
Sudoku puzzles can be played on any $n \time n$ grid, where $n$ is the square of an integer (e.g., 4, 9, 16). For example, in a $4 \time 4$ Sudoku, you fill the grid with the numbers 1 to 4, in a $9 \time 9$ Sudoku (the standard version), you fill the grid with the numbers 1 to 9, and so on.
...
- **Mini Sudoku**: This is a smaller version with $4 \time 4$ grid, ideal for beginners. The subgrids are $2 \time 2$, and the puzzle uses digits 1 to 4.

- **Standard Sudoku**: This is the most common version, with $9 \time 9$ grid, $3 \time 3$ subgrids and digits 1 to 9.

- **Large Sudoku**: This uses larger grids, $16 \time 16$ grid, $4 \time 4$ subgrids, and digits 1 to 16.

- **Extreme Sudoku**: Rarely seen, this massive $25 \time 25$ grid uses $5 \time 5$ subgrids and digits 1 to 25, and is extremely challenging.
