...
![Schematic visualization of the axisymmetric vortex geometry underlying the blow-up construction. Fluid trajectories spiral inward toward the symmetry axis while the flow undergoes axial stretching, producing the coupled radial contraction, swirl, and axial transport used to concentrate the solution. Source: OpenAI, [Official article](https://openai.com/index/navier-stokes-solution/).](navier-stokes-axisymmetric-vortex.webp){#fig-when-open-problems-became-benchmarks-axisymmetric-vortex fig-align="center" width="72%"}
