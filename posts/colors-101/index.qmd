...
rgb = sRGBColor(128., 0., 128., is_upscaled=True) # <1> # is_upscaled=True if you're using 0-255 range

# Convert the sRGB color to other color spaces
lab = convert_color(rgb, LabColor)      # <2> # CIELab
...
print("CIELab: ", lab)      # <3> # CIELab:  LabColor (lab_l:29.7843 lab_a:58.9285 lab_b:-36.4932) 
