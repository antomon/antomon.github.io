...
description: "A retrospective on the engineering and mathematical development of a multilevel model for racing-shell dynamics, from a stand-alone reduced simulator to coupled free-surface CFD."
abstract: |
...
categories: [essay, mathematics, professional and research work, software development, 🇬🇧]
...
\mathbf y(t)\,dt.
$$ {#eq-the-mathematics-behind-a-racing-shell-published-dissipated-energy}

The factor $1/2$ is retained here because it is the convention used in the published calculation from which the reported dissipation values were obtained.[^the-mathematics-behind-a-racing-shell-original-paper] If instead $\mathbf f_{\mathrm{rad}}=-\mathbf S_r\mathbf v$ is interpreted directly as an instantaneous damping force acting on real velocities, its mechanical work over an interval is
...
\mathcal R(\mathbf W),
\qquad
\mathsf A(\mathbf y,t)\dot{\mathbf y}
=
\mathcal F_s
\left(
\mathbf f_{\mathrm{ext}}(\mathbf W)
\right).
$$ {#eq-the-mathematics-behind-a-racing-shell-two-way-cfd-coupling}
...
: Practical questions addressed by the multilevel modelling framework. {#tbl-the-mathematics-behind-a-racing-shell-practical-objectives}
...
[^the-mathematics-behind-a-racing-shell-moxp3-report]: Formaggia, L., Miglio, E., Del Grosso, L., Montano, A., & Pandini, S. (2004). **Modello dinamico di una imbarcazione da canottaggio**. _MOX Report MOXP3, Politecnico di Milano_. [Official record](https://mox.polimi.it/reports-and-books/publication-results/?id=91)
...
[^the-mathematics-behind-a-racing-shell-mox-context]: MOX Laboratory. (n.d.). **Who We Are**. _Department of Mathematics, Politecnico di Milano_. [Official MOX page](https://mox.polimi.it/)

[^the-mathematics-behind-a-racing-shell-quarteroni-mox]: MOX Laboratory. (n.d.). **Alfio Quarteroni**. _Department of Mathematics, Politecnico di Milano_. [Official profile](https://mox.polimi.it/people/alfio-quarteroni/)

[^the-mathematics-behind-a-racing-shell-filippi-world-rowing]: World Rowing. (2014). **Filippi boat ready for 2013 Parmigiani Spirit Award winner**. _World Rowing_. [Article](https://www.worldrowing.com/2014/03/18/filippi-boat-ready-for-2013-parmigiani-spirit-award-winner/)

[^the-mathematics-behind-a-racing-shell-filippi-technical-support]: Mola, A., Formaggia, L., & Miglio, E. (2007). **Simulation of the dynamics of an Olympic rowing boat**. _Communications to SIMAI Congress, 2_. [DOI](https://doi.org/10.1685/CSC06174) Formaggia, L., Miglio, E., Mola, A., & Scotti, A. (2009). **Numerical simulation of the dynamics of boats by a variational inequality approach**. _Variational Analysis and Aerospace Engineering_. [DOI](https://doi.org/10.1007/978-0-387-95857-6_12)

[^the-mathematics-behind-a-racing-shell-filippi-partnership]: Formaggia, L., Mola, A., Parolini, N., & Pischiutta, M. (2010). **A three-dimensional model for the dynamics and hydrodynamics of rowing boats**. _Proceedings of the Institution of Mechanical Engineers, Part P: Journal of Sports Engineering and Technology, 224_(1), 51–61. [DOI](https://doi.org/10.1243/17543371JSET46)

[^the-mathematics-behind-a-racing-shell-filippi-kime]: Filippi Lido S.r.l. (n.d.). **Canottaggio 2.0**. _Filippi Boats / Regione Toscana_. [Official project presentation](https://www.filippiboats.com/application/files/7715/3986/9735/PRESENTAZIONE_CANOTTAGGIO_2.0-logocorretto.pdf)