...
description: "Gli aggiornamenti Terna agli Allegati A.13, A.69 e A.52 segnano il passaggio da una logica di semplice collegamento dati a una postura architetturale in cui controllo, difesa, monitoraggio, telecomunicazioni, cybersecurity e governance di ciclo di vita diventano proprietà strutturali degli impianti connessi."
abstract: |
  Questo articolo interpreta gli aggiornamenti Terna agli Allegati A.13, A.69 e A.52 del Codice di Rete come il segnale di una trasformazione profonda della postura tecnica richiesta agli impianti connessi alla rete elettrica. La tesi centrale è che tali aggiornamenti non costituiscano una normale manutenzione documentale, ma il passaggio da un modello fondato sul semplice collegamento dati verso Terna a un modello di interoperabilità operativa, nel quale controllo, difesa, monitoraggio, telecomunicazioni, cybersecurity, disponibilità e governance di ciclo di vita devono essere progettati come una sola catena cyber-fisica.

  Il metodo di lettura adottato distingue tre livelli. Il primo è documentale: soglie, apparati, tempi di adeguamento, requisiti di connessione e obblighi formali. Il secondo è funzionale: osservabilità, teledistacco, modulazione, limitazione della produzione, registrazione degli eventi, verifica dei flussi, disponibilità operativa e gestione del guasto. Il terzo, decisivo, è architetturale: gli allegati vengono letti come requisiti che incidono su layout, cavidotti, fibre ottiche, router, RTU, UPDM, SCADA, EMS, BMS, PCS, PPC, accessi remoti, logging, backup, contratti O&M, responsabilità dei fornitori, commissioning e mantenimento della conformità nel tempo.

  L’Allegato A.13 viene analizzato come il passaggio dal telecontrollo alla connessione operativa dell’impianto. La revisione rende esplicito il rilievo del livello a 36 kV per impianti di produzione, accumulo, consumo e autoconsumo connessi direttamente o indirettamente alla RTN, con impatti particolarmente rilevanti per BESS, impianti fotovoltaici, eolici e configurazioni ibride. La connessione verso Terna non è più una generica estensione della LAN OT, ma un dominio dedicato, fondato su architetture TLC/OT governate, router conformi, funzione di switching integrata, BGP, IPSec ove previsto, indirizzamento governato, assenza di switch esterni intermedi, doppia fibra ottica monomodale nei casi applicabili, chiara demarcazione fra infrastruttura del Titolare e infrastruttura Terna, collaudi, gestione H24, monitoraggio dei collegamenti e responsabilità esplicite verso provider, O&M contractor, telco, integratori e fornitori.

  L’Allegato A.69 viene letto come la formalizzazione del sistema di difesa quale catena OT/TLC/cyber. L’impianto non deve soltanto inviare misure o ricevere comandi, ma partecipare a una logica distribuita di difesa della rete. Questo richiede canali resilienti, comandi deterministici, misure affidabili, tempi di attuazione verificabili, integrazione coerente fra EMS, BMS e PCS, gestione dei siti multi-tecnologia, limiti di scambio di sito, certificazione della catena di comando e acquisizione, sigillatura dei componenti rilevanti, monitoraggio locale, retention dei flussi, gestione del ripristino e cybersecurity organica. Per i BESS e gli impianti elettrochimici, la revisione assume particolare rilievo perché introduce comandi e misure dedicati, quali potenza, capacità disponibile, massimo assorbimento, massima erogazione, azzeramento dello scambio, emergenza e ripristino.

  L’Allegato A.52 viene interpretato come la trasformazione dell’UPDM da apparato periferico di elettro-automazione a componente cyber-fisico critico. L’UPDM deve mantenere funzioni rapide e deterministiche, ma deve anche operare in un ambiente caratterizzato da doppie interfacce Ethernet, alta affidabilità, IEC 61850, segregazione, filtraggio delle connessioni autorizzate, identity management, secure boot, firma del firmware, gestione delle configurazioni, logging, patching, RADIUS, RBAC, hardening, supply chain e gestione delle vulnerabilità. Ne deriva che UPDM, RTU, router Terna e apparati di campo non possono essere trattati come normali dispositivi della LAN OT, ma come una zona dedicata con flussi strettamente necessari, responsabilità di manutenzione definite e capacità di prova, audit e ricostruzione degli eventi.

  L’articolo estende poi la lettura agli Allegati A.17, A.68 e A.18. Anche dove non compare un capitolo cybersecurity organico paragonabile a quello di A.13, A.52 e A.69, tali allegati incidono comunque sull’architettura IT/OT perché rendono controllabili, misurabili, verificabili e documentabili le prestazioni tecniche dell’impianto. Centrali eoliche, fotovoltaiche e sistemi ibridi devono essere governati attraverso controllori centrali, PPC, inverter, aerogeneratori, protezioni, telemisure, telesegnali, integrazione UPDM, file di setting, versioni firmware, modelli dinamici, prove di conformità, controlli periodici e gestione del ciclo di vita. La conformità Terna non coincide quindi con una dichiarazione iniziale in fase di commissioning, ma diventa una proprietà da mantenere, dimostrare e aggiornare durante l’esercizio.

  La traiettoria tecnica viene infine collocata nel quadro regolatorio europeo e nazionale definito da NIS2, DORA, Cyber Resilience Act e Perimetro di Sicurezza Nazionale Cibernetica. La cybersecurity industriale non viene trattata come presidio specialistico esterno ai processi di esercizio, ma come requisito ordinario di continuità operativa, responsabilità della filiera, resilienza e governance. In un contesto in cui automazione degli attacchi, crime-as-a-service, AI generativa, supply chain attack e sistemi legacy abbassano il costo unitario dell’offesa, anche impianti e fornitori storicamente considerati marginali diventano parte del perimetro reale di rischio.

  L’appendice traduce questa impostazione in una guida pratica per Titolari, BoP, integratori e fornitori. Il principio non è costruire per ogni impianto una grande infrastruttura SOC industriale, ma adottare una proporzionalità rigorosa: segmentazione in zone e conduits secondo la logica IEC 62443, separazione fra campo, controllo locale, dominio Terna, OT DMZ, servizi OT, IT/SOC, terze parti e servizi ausiliari, controllo degli accessi remoti tramite VPN con MFA, DMZ e jump host, divieto di accessi diretti IT-to-OT e vendor-to-OT, firewalling leggibile, logging centralizzato, SIEM o SOC senza amministrazione diretta degli asset critici, IDS/NDR passivo, backup, patch staging, asset inventory, gestione dei cambiamenti, evidenze di configurazione, versionamento di firmware e setting, e procedure di manutenzione e audit.

  La conclusione operativa è che il perimetro Terna deve entrare nel progetto dell’impianto fin dalle prime fasi. La domanda rilevante non è più se l’impianto disponga di un canale verso Terna, ma se possieda una catena end-to-end, fisica, logica, funzionale e cyber, capace di sostenere controllo, difesa, monitoraggio, collaudo, manutenzione, auditabilità, gestione del guasto e continuità operativa per tutto il ciclo di vita dell’asset.
date: "2026-05-16"
date-modified: "2026-05-17"
categories: [cybersecurity, energy, essay, 🇮🇹]
keywords: Terna, Italian power grid, grid code, electricity transmission, critical infrastructure, OT cybersecurity, IT/OT architecture, operational technology, industrial control systems, cyber-physical systems, grid monitoring, grid control, power system security, energy infrastructure, renewable energy, BESS, battery energy storage systems, photovoltaic plants, wind farms, high-voltage substations, 36 kV connection, RTN, UPDM, RTU, SCADA, EMS, BMS, PCS, PPC, MPLS, IEC 60870-5-104, IEC 61850, IEC 62443, NIS2, CRA, PSNC, OT DMZ, jump host, network segmentation, zones and conduits, firewall, SIEM, IDS, NDR, remote access, asset inventory, compliance, resilience, grid observability, telemetry, protection systems, conformance testing, lifecycle governance
...
L’**Allegato A.17** disciplina le condizioni generali di connessione delle centrali eoliche alle reti AAT e AT, con riferimento ai sistemi di protezione, regolazione e controllo. La revisione 2026 dichiara espressamente l’aggiornamento dei requisiti tecnici connessi al monitoraggio dei servizi e alla modulazione o distacco della generazione.[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a17-revisione]
...
L’allegato distingue le connessioni di Tipo 1, relative a livelli di tensione pari o superiori a 110 kV, e le connessioni di Tipo 2, relative alle sezioni 36 kV di stazioni elettriche del Gestore.[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a17-36kv] Questa distinzione conferma che il tema 36 kV non è confinato agli Allegati A.13 e A.69, ma entra anche nei requisiti specifici delle centrali eoliche. Il disegno dei sistemi di protezione, regolazione e controllo deve quindi essere coerente con il boundary Terna, con le modalità di connessione, con lo scambio dati e con gli apparati di difesa e monitoraggio previsti dagli allegati trasversali.

Per gli impianti eolici esistenti, A.17 introduce obblighi con impatto diretto sulla catena OT. In particolare, per impianti con potenza efficiente netta maggiore o uguale a 1 MW, è prevista l’installazione dell’UPDM conforme all’Allegato A.52 e la connessione dello stesso al Sistema di Difesa del Gestore secondo le modalità dell’Allegato A.69. Inoltre, ove il sistema di controllo dell’impianto lo consenta, deve essere attivata la funzionalità di limitazione tramite segnale da UPDM.[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a17-updm]
...
L’**Allegato A.68** svolge per le centrali fotovoltaiche una funzione analoga a quella svolta dall’Allegato A.17 per le centrali eoliche. La revisione 2026 dichiara l’aggiornamento dei requisiti tecnici connessi al monitoraggio dei servizi e alla modulazione o distacco della generazione.[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a68-revisione]
...
Come A.17, anche A.68 distingue connessioni di Tipo 1 e connessioni di Tipo 2, includendo le sezioni 36 kV di stazioni elettriche del Gestore.[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a68-36kv] Questo rafforza il principio secondo cui il 36 kV è diventato un perimetro tecnico esplicito. La progettazione fotovoltaica deve quindi considerare il punto di connessione, il dominio Terna, gli apparati di protezione e controllo, i flussi informativi, le limitazioni e il monitoraggio come parti di uno stesso sistema.

L’allegato precisa inoltre che, per impianti fotovoltaici con sistemi di accumulo, A.68 tratta i requisiti relativi alla centrale fotovoltaica, mentre i requisiti relativi ai Sistemi di Accumulo sono rinviati all’Allegato A.79.[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a68-storage] Questo è rilevante per i progetti PV+BESS: il fotovoltaico resta disciplinato da A.68, lo storage richiede il coordinamento con il proprio allegato specifico e con gli allegati trasversali A.13, A.52 e A.69.

Per gli impianti fotovoltaici esistenti, A.68 prevede l’obbligo di installazione dell’UPDM per impianti con potenza efficiente netta maggiore o uguale a 1 MW, con conformità all’Allegato A.52 e connessione al Sistema di Difesa secondo l’Allegato A.69. Inoltre, ove il sistema di controllo d’impianto lo consenta, deve essere attivata la funzionalità di limitazione tramite segnale da UPDM.[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a68-updm]
...
A.68 definisce anche una priorità fra azioni di protezione e azioni di controllo, includendo protezione dell’impianto, protezione della rete, teledistacco, supporto alla tensione durante i guasti, regolazione FSM/LFSM, limitazione della produzione, regolazione secondaria o ILF, piani di produzione e regolazione della potenza reattiva.[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a68-priorita]
...
A.18 richiama inoltre verifiche su apparati UPDM e UVRP, sui rapporti degli ultimi controlli, sul piano dei controlli periodici e sulle funzionalità. Richiede anche verifiche su protezioni, tarature, rapporti di prova, piano delle tarature periodiche, conformità metrologica della strumentazione e registrazioni oscilloperturbografiche degli eventi di parallelo.[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a18-updm-protezioni]
...
Per il BoP, questo significa che la _fornitura deve includere non solo l’impianto funzionante, ma anche una catena documentale e tecnica completa_: architettura di rete, matrice dei flussi, integrazione UPDM, mapping teleinformazioni, logiche di limitazione, priorità di controllo, file di setting, versioni firmware, configurazioni esportate, rapporti di prova, modelli, as-built e procedure di manutenzione.
...
[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a17-revisione]: Allegato A.17, Rev. 04 del 14/05/2026, “Centrali eoliche — Condizioni generali di connessione alle reti AAT e AT. Sistemi di protezione regolazione e controllo”, storia delle revisioni: “Aggiornamento dei requisiti tecnici connessi al monitoraggio dei servizi e alla modulazione/distacco della generazione e revisione generale”.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a17-36kv]: Allegato A.17, Rev. 04 del 14/05/2026, paragrafo 2, “Campo di applicazione”: distinzione fra connessioni di Tipo 1 e connessioni di Tipo 2, queste ultime riferite a sezioni 36 kV di stazioni elettriche del Gestore.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a17-updm]: Allegato A.17, Rev. 04 del 14/05/2026, paragrafo 2, “Campo di applicazione”: obblighi per impianti esistenti relativi a installazione dell’UPDM conforme all’Allegato A.52 e connessione al Sistema di Difesa secondo l’Allegato A.69; attivazione della funzionalità di limitazione tramite segnale UPDM ove tecnicamente consentito.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a17-priorita]: Allegato A.17, Rev. 04 del 14/05/2026, sezione 9, “Priorità azioni di controllo e azioni di protezione”.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a17-monitoraggio]: Allegato A.17, Rev. 04 del 14/05/2026, sezione 10, “Monitoraggio e scambio dati con il sistema di controllo di Terna”.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a68-revisione]: Allegato A.68, Rev. 05 del 14/05/2026, “Centrali fotovoltaiche — Condizioni generali di connessione alle reti AAT e AT. Sistemi di protezione regolazione e controllo”, storia delle revisioni: “Aggiornamento dei requisiti tecnici connessi al monitoraggio dei servizi e alla modulazione/distacco della generazione e revisione generale”.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a68-36kv]: Allegato A.68, Rev. 05 del 14/05/2026, paragrafo 2, “Campo di applicazione”: distinzione fra connessioni di Tipo 1 e connessioni di Tipo 2, queste ultime riferite a sezioni 36 kV di stazioni elettriche del Gestore.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a68-storage]: Allegato A.68, Rev. 05 del 14/05/2026, paragrafo 2, “Campo di applicazione”: precisazione secondo cui, per impianti con Sistemi di Accumulo, l’allegato tratta i requisiti relativi alla centrale fotovoltaica, mentre per i Sistemi di Accumulo si rimanda all’Allegato A.79 del Codice di Rete.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a68-updm]: Allegato A.68, Rev. 05 del 14/05/2026, paragrafo 2, “Campo di applicazione”: obblighi per impianti esistenti relativi a installazione dell’UPDM conforme all’Allegato A.52 e connessione al Sistema di Difesa secondo l’Allegato A.69; attivazione della funzionalità di limitazione tramite segnale UPDM ove tecnicamente consentito.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a68-priorita]: Allegato A.68, Rev. 05 del 14/05/2026, sezione 9, “Priorità azioni di controllo e azioni di protezione”.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a68-telecontrollo]: Allegato A.68, Rev. 05 del 14/05/2026, sezione 10 e Appendice C, relative a monitoraggio, scambio dati con il sistema di controllo di Terna e informazioni per telecontrollo in tempo reale.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a18-revisione]: Allegato A.18, Rev. 03 del 14/05/2026, “Verifica della conformità degli impianti di produzione alle prescrizioni tecniche del Gestore”, storia delle revisioni: “Revisione campo di applicazione e precisazioni sulle modalità di gestione delle prove in autonomia”.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a18-tipiverifica]: Allegato A.18, Rev. 03 del 14/05/2026, sezione 6, “Classificazione e modalità di svolgimento delle verifiche”: verifiche con ispezioni strumentali, monitoraggio continuo strumentale, prove in autonomia e ispezioni visive/documentali.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a18-ppm]: Allegato A.18, Rev. 03 del 14/05/2026, sezioni relative alle verifiche dei requisiti per la gestione del sistema elettrico dei PPM e alle prove su avviamento, presa di carico, controllo e parallelo.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a18-updm-protezioni]: Allegato A.18, Rev. 03 del 14/05/2026, sezioni relative alle verifiche su apparati UPDM/UVRP, protezioni, tarature, rapporti di prova, controlli periodici, conformità metrologica e registrazioni oscilloperturbografiche.

[^controllo-monitoraggio-rete-nuova-postura-sicurezza-impianti-connessi-a18-bess-certificazione]: Allegato A.18, Rev. 03 del 14/05/2026, sezioni relative alle modalità di verifica per PPM e BESS, organismi certificatori, rapporti di prova, autocertificazioni e prove in autonomia.
...
%%| fig-alt: "Diagramma che confronta un accesso remoto corretto tramite VPN con MFA, OT DMZ e jump host con un accesso remoto vietato direttamente verso la LAN OT e gli asset critici."
%%| fig-align: center
...
```{mermaid}
%%| label: fig-accesso-remoto-ot-dmz-jump-host
%%| fig-cap: "Accesso remoto controllato tramite OT DMZ e jump host"
%%| fig-alt: "Diagramma che mostra fornitori e manutentori che accedono tramite VPN con MFA, firewall, OT DMZ e jump host prima di raggiungere asset OT autorizzati."
%%| fig-align: center
%%{init: {"theme": "neo", "look": "handDrawn", "layout": "elk"}}%%
...
```{mermaid}
%%| label: fig-controllo-locale-dominio-terna
%%| fig-cap: "Separazione fra controllo locale di impianto, campo e dominio Terna"
%%| fig-alt: "Diagramma che mostra il campo, il controllo locale, RTU, UPDM e router Terna come domini distinti ma interconnessi."
%%| fig-align: center
%%{init: {"theme": "neo", "look": "handDrawn", "layout": "elk"}}%%
...
```{mermaid}
%%| label: fig-log-monitoraggio-evidenze-ot
%%| fig-cap: "Raccolta log, monitoraggio passivo ed evidenze verso SIEM/SOC"
%%| fig-alt: "Diagramma che mostra log forwarder, SIEM/SOC, sistemi OT, firewall, RTU, UPDM, router Terna, backup e IDS/NDR passivo."
%%| fig-align: center
%%{init: {"theme": "neo", "look": "handDrawn", "layout": "elk"}}%%
...
```{mermaid}
%%| label: fig-servizi-ausiliari-non-ot
%%| fig-cap: Separazione dei servizi ausiliari non OT dalla rete OT
%%| fig-alt: Diagramma che mostra videosorveglianza, building management e Wi-Fi separati dalla rete OT, con solo eventuale invio di log verso il log forwarder.
%%| fig-align: center
%%{init: {"theme": "neo", "look": "handDrawn", "layout": "elk"}}%%
