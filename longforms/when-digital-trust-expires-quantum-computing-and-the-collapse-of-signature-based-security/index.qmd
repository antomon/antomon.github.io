...
categories: [cybersecurity, post-quantum cryptography, quantum computing, 🇬🇧]
...
Recent resource estimates show that factoring a 2048-bit RSA modulus may be achievable with fewer than one million physical qubits under optimistic but plausible assumptions, with runtimes on the order of days rather than years.[^shor-resource-estimates]
