...
flowchart LR
    ...
    SURVEILLANCE[/EU Regulation 2019/1020<br/>market surveillance/]:::overlay
...
* either the full EU declaration of conformity or a simplified EU declaration of conformity; and where a simplified declaration is supplied, the exact internet address at which the full declaration can be accessed;
...
Article 35(2) establishes a statutory implementation target: Member States must strive to ensure, by **11 December 2026**, that a sufficient number of notified bodies exists in the Union to avoid conformity-assessment bottlenecks and barriers to market entry. The Commission implementation roadmap repeats that target.[^cyber-resilience-act-the-new-product-security-baseline-implementation-page]
...
[^cyber-resilience-act-the-new-product-security-baseline-enisa-srp-faq]: European Union Agency for Cybersecurity. (2026). **Single Reporting Platform (SRP)**. _ENISA_. [Official guidance and FAQs](https://www.enisa.europa.eu/topics/product-security-and-certification/single-reporting-platform-srp)
