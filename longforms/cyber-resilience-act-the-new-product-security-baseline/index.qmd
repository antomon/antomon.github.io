...
* where applicable, access to the EU declaration of conformity;
...
The Commission guidance recognises that manufacturers of legacy products may no longer possess old build environments, compatible dependencies, testing infrastructure, or staff familiar with the product. Those practical limitations do not remove the Article 14 notification duty, although they can affect what information the manufacturer is realistically able to establish.
...
Third, Article 58 addresses **formal non-compliance**, such as defects relating to CE marking, the declaration, required information, identification, or technical documentation. Persistent formal non-compliance can ultimately lead to restriction, prohibition, recall, or withdrawal.
...
There is nevertheless a formal-status distinction that should not be hidden. The C(2026) 5252 communication approving the content of the draft guidance states that the annexed guidance is to be **formally adopted by the Commission at a later date once all language versions are available**. The annex itself also states that it does not bind the Commission, does not cover the CRA exhaustively, and cannot prejudge authoritative interpretation by the Court of Justice of the European Union.[^cyber-resilience-act-the-new-product-security-baseline-commission-guidance-status]
...
The Commission implementation roadmap itself reflects the transitional nature of this ecosystem: it identifies **11 December 2026** as the milestone for notification of sufficient conformity-assessment bodies across Member States.[^cyber-resilience-act-the-new-product-security-baseline-implementation-page]
...
* **11 December 2026** — Commission implementation roadmap milestone for sufficient CRA conformity-assessment bodies across Member States;
...
flowchart LR
    ...
    NB[/11 Dec 2026<br/>sufficient notified bodies<br/>Commission roadmap milestone/]:::overlay
