...
/* full width white strip directly under the banner */
.quarto-title-block .banner-info-strip {
  width: 100%;
...
.quarto-title-block .banner-info-strip .quarto-title-meta {
  width: 100%;
  max-width: none !important;
  margin: 0 0 1rem 0 !important;
}

.quarto-title-block .banner-info-strip .article-standfirst {
  width: 100%;
  max-width: none;
  box-sizing: border-box;
  font-size: 1.08rem;
...
.quarto-title-block .banner-info-strip .article-standfirst p {
  margin: 0;
}
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!titleBlock || !banner || !meta) return;

  var strip = document.createElement("div");
  strip.className = "banner-info-strip";

  strip.appendChild(meta);

  if (standfirst) {
    strip.appendChild(standfirst);
  }
