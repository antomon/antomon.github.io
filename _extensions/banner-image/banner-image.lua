...
.banner-meta-row.row-1 .quarto-title-meta-author > div {
  min-width: 0;
}
...
@media (max-width: 575px) {
  ...
  .banner-meta-row.row-1 .quarto-title-meta-author > :nth-child(1),
  .banner-meta-row.row-1 .quarto-title-meta-author > :nth-child(2),
  .banner-meta-row.row-1 .quarto-title-meta-author > :nth-child(3),
  .banner-meta-row.row-1 .quarto-title-meta-author > :nth-child(4) {
    grid-column: auto;
    grid-row: auto;
  }
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  function buildReadingTimeBlock() {
    ...
    heading.textContent = "Reading time";
