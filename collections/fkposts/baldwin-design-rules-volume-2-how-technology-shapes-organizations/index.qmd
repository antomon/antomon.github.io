...
- Williamson, O. E. (1985). *The economic institutions of capitalism: Firms, markets, relational contracting*. Free Press. [Link](https://archive.org/details/economicinstitut00will)

- Milgrom, P., & Roberts, J. (1992). *Economics, organization and management*. Prentice Hall. [Link](https://www.worldcat.org/title/25164524)
...
- von Hippel, E. (2005). *Democratizing innovation*. MIT Press. [Link](https://mitpress.mit.edu/9780262525435/democratizing-innovation/)

- Raymond, E. S. (1999). *The cathedral and the bazaar: Musings on Linux and open source by an accidental revolutionary*. O’Reilly Media. [Link](https://www.oreilly.com/library/view/the-cathedral-the/0596001088/)
...
| **Year**          | 2024                                                                                                         |
+-------------------+--------------------------------------------------------------------------------------------------------------+
| **Authors**       | [Carliss Y. Baldwin](https://www.hbs.edu/faculty/Pages/profile.aspx?facId=6419)                              |
+-------------------+--------------------------------------------------------------------------------------------------------------+
...
+-------------------+--------------------------------------------------------------------------------------------------------------+
| **Other links**   | [Publisher book page](https://direct.mit.edu/books/book/2487108/Design-Rules-Volume-2-How-Technology-Shapes) |
+-------------------+--------------------------------------------------------------------------------------------------------------+
