...
+-------------------+----------------------------------------------------------------------------------------------------------------------+
| **Downloads**     | [Books site & code](https://probml.github.io/) / [GitHub notebooks](https://github.com/probml/pyprobml)              |
+-------------------+----------------------------------------------------------------------------------------------------------------------+
| **Other links**   | [MLAPP (2012) resources](https://www.cs.ubc.ca/~murphyk/MLbook/)                                                     |
+-------------------+----------------------------------------------------------------------------------------------------------------------+
| **ISBNs**         | 978-0262046824 (*Introduction*), 978-0262048378 (*Advanced Topics*)                                                  |
+-------------------+----------------------------------------------------------------------------------------------------------------------+
| **Buy online**    | [MIT Press, *Introduction*](https://mitpress.mit.edu/9780262046824/probabilistic-machine-learning/) / [MIT Press, *Advanced Topics*](https://mitpress.mit.edu/9780262048439/probabilistic-machine-learning/) |
+-------------------+----------------------------------------------------------------------------------------------------------------------+
